...
def test_ap_CN_diffusion(ap):
    ...
    aej_U238, aej_U235, aej_Th, aej_Sm, corr_factors = ap.apatite_alpha_ejection()
    r_step = 60/(257.5)
    He_profile = ap.CN_diffusion(257,r_step,ap.get_relevant_tT(),diff_list,aej_U238,aej_U235,aej_Th,aej_Sm)
...
def test_zirc_CN_diffusion(zirc):
    ...
    aej_U238, aej_U235, aej_Th, aej_Sm, corr_factors = zirc.zircon_alpha_ejection()
    r_step = 60/(257.5)
    He_profile = zirc.CN_diffusion(257,r_step,zirc.get_relevant_tT(),diff_list,aej_U238,aej_U235,aej_Th,aej_Sm)
    He_profile = np.array(He_profile)
